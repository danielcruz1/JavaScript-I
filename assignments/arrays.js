...
console.log(`Car 33 is a ${carid33.car_year} ${carid33.car_make} ${carid33.car_model}`);
...
console.log(`The last car in your inventory is a ${lastCar.car_make} ${lastCar.car_model}`);
...
for(let i = 0; i<inventory.length; i++){
  if(!alphabetCars.includes(inventory[i].car_model)){
    alphabetCars.push(inventory[i].car_model);
  }
}

alphabetCars.sort();
console.log(alphabetCars);
